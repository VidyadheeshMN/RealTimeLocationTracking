package com.example.realtimelocationtracking.Model;
...
public class MyLocation {
    ...
    private boolean complete, fromMockProviderk;
    ...
    public boolean isFromMockProviderk() {
        return fromMockProviderk;
    }

    public void setFromMockProviderk(boolean fromMockProviderk) {
        this.fromMockProviderk = fromMockProviderk;
    }
